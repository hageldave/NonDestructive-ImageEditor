...
/** Deprecated since it is waaaay slower than current implementation of {@link PixelArray}
 */
@Deprecated
public class PixelArray1 implements IPixelCollection {
	...
	public PixelArray1(int width, int height) {
		this.imageWidth = width;
		this.rgbaPixels = new int[width*height][4];
	}

	public PixelArray1(int[][] rgbaPixels, int imageWidth) {
	...
	public PixelArray1(PixelArray1 pixArr) {
	...
	public PixelArray1(IPixelCollection pixArr, int divider) {
	...
	public PixelArray1(BufferedImage img){
	...
	public PixelArray1(BufferedImage img, int divider){
		this.divider = divider;
